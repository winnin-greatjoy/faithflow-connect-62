        ...
        <>
          ...
          >
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <Badge
                      variant="outline"
                      className="text-[9px] font-bold border-primary/20 text-primary uppercase tracking-widest px-3"
                    >
                      {person.status}
                    </Badge>
                  </div>
                  ...
                  <p className="text-xs font-bold text-muted-foreground opacity-60 mt-1 uppercase tracking-widest">
                    {person.phone || 'No Mobile Registered'}
                  </p>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto px-8 space-y-8 custom-scrollbar pb-8">
              ...
              <section className="space-y-4">
                ...
                <Card className="p-6 rounded-3xl border border-primary/5 bg-muted/30 shadow-inner">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground opacity-60 mb-0.5">
                        CURRENT ZONE
                      </p>
                      <h5 className="text-sm font-black">
                        {person.currentZone || 'Not in a Zone'}
                      </h5>
                    </div>
                  </div>
                  <div className="mt-4 pt-4 border-t border-primary/5 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold text-muted-foreground">
                        LAST SCAN: {person.lastIn || '6:42 PM'}
                      </span>
                    </div>
                    <Badge className="bg-emerald-500/10 text-emerald-600 border-none font-black text-[8px] px-2">
                      VALIDATED
                    </Badge>
                  </div>
                </Card>
              ...
              <section className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge
                    variant="outline"
                    className="border-red-500/20 text-red-600 bg-red-500/5 px-3 py-1 font-black text-[9px] uppercase tracking-widest"
                  >
                    <Heart className="h-3 w-3 mr-1.5 fill-red-600" /> Asthmatic
                  </Badge>
                  <Badge
                    variant="outline"
                    className="border-emerald-500/20 text-emerald-600 bg-emerald-500/5 px-3 py-1 font-black text-[9px] uppercase tracking-widest"
                  >
            ...
            <div className="p-8 bg-muted/20 border-t border-primary/5 grid grid-cols-2 gap-3">
              ...
              <Button
                variant="outline"
                className="border-primary/10 bg-white h-12 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-primary/5 transition-all flex items-center justify-center gap-2"
              >
                <LogOut className="h-4 w-4" /> Force Exit
              </Button>
              <Button
                variant="ghost"
                className="col-span-2 h-12 rounded-2xl font-black text-[10px] uppercase tracking-widest text-destructive hover:bg-destructive/5 flex items-center justify-center gap-2"
              >
