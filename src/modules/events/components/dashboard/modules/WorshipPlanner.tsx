            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="lg:col-span-2 p-8 bg-white rounded-[32px] border-none shadow-2xl shadow-primary/5">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground opacity-60">Live Service Setlist</p>
                        </div>
                        ...
                        {[
                            ...
                            <div key={i} className="flex items-center gap-6 p-4 rounded-2xl bg-muted/30 border border-primary/5 group hover:bg-white hover:shadow-xl hover:shadow-primary/5 transition-all">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-[10px] font-bold text-muted-foreground uppercase">{item.team}</p>
                                </div>
                                <Badge variant="outline" className="h-6 text-[8px] font-black border-primary/10">{item.duration}</Badge>
                ...
                <div className="space-y-6">
                    <Card className="p-8 bg-primary rounded-[32px] text-white border-none shadow-2xl shadow-primary/20">
                        ...
                        <p className="text-xs font-medium opacity-60 mb-6">Access lyrics and technical sheets for today's setlist.</p>
                        <Button variant="ghost" className="w-full bg-white/10 hover:bg-white/20 text-white h-12 rounded-xl font-black text-[10px] uppercase tracking-widest border-none">
                            Open Media Library
                        </Button>
                    </Card>
                    ...
                    <Card className="p-8 bg-white rounded-[32px] border-none shadow-2xl shadow-primary/5">
                        ...
                        <div className="flex -space-x-2">
                            {[1, 2, 3, 4].map(i => (
                                <div key={i} className="h-10 w-10 rounded-xl bg-muted border-2 border-white flex items-center justify-center text-xs font-black text-primary shadow-sm">
