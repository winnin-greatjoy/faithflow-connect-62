    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-6 bg-destructive text-white border-none rounded-[32px] shadow-2xl shadow-destructive/20 relative overflow-hidden group">
          <div className="relative z-10">
            ...
            <Button
              ...
              className="w-full bg-white text-destructive hover:bg-white/90 font-black h-12 rounded-xl text-[10px] uppercase tracking-widest"
            >
        ...
        {[
          ...
          <Card
            key={i}
            className="p-6 border border-primary/5 rounded-[32px] bg-white shadow-xl shadow-primary/5"
          >
        ...
        <Card className="xl:col-span-2 p-8 bg-white rounded-[40px] border border-primary/5 shadow-2xl shadow-primary/5">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground opacity-60 mb-1">
                Live Care Monitoring
              </p>
            </div>
            <div className="flex gap-2">
              <Button
                onClick={handleDispatch}
                className="bg-destructive/10 text-destructive hover:bg-destructive hover:text-white h-10 px-6 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all"
              >
                Dispatch
              </Button>
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-between p-5 rounded-3xl border border-primary/5 hover:border-primary/20 transition-all bg-muted/30 group"
              >
            ...
            <div className="relative z-10">
              ...
              <div className="flex -space-x-3 mb-6">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="h-10 w-10 rounded-xl bg-white border-2 border-primary/10 flex items-center justify-center font-black text-xs text-primary shadow-sm"
                  >
