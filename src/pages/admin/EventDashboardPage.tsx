              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <Badge
                      variant="outline"
                      className="text-[10px] font-bold border-primary/20 text-primary uppercase tracking-widest px-3"
                    >
                      {event.status}
                    </Badge>
                  </div>
                          ...
                          <div className="flex gap-5 relative z-10">
                            <div
                              className={cn(
                                ...
                                event.active_modules?.includes(module.id)
                                  ...
                                  : 'bg-muted text-primary opacity-60'
                              )}
                            >
                            ...
                            <div className="flex-1 space-y-1.5">
                              <div className="flex items-center justify-between">
                                ...
                                <Badge
                                  variant="outline"
                                  className="text-[9px] font-black uppercase tracking-widest opacity-50 border-none p-0"
                                >
                                  {module.category}
                                </Badge>
                              </div>
            ...
            <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  <AnimatePresence mode="popLayout">
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                  ...
                                  <span className="text-[10px] font-black uppercase tracking-widest text-emerald-600 opacity-80">
                                    Online
                                  </span>
                                </div>
                              </div>
                                ...
                                {event.module_assignments?.[module.id] ? (
                                  <div className="flex items-center gap-2">
                                    <div className="h-5 w-5 rounded-lg bg-primary text-white flex items-center justify-center text-[8px] font-black">
                                      {members
                                        .find((m) => m.id === event.module_assignments?.[module.id])
                                        ?.fullName.charAt(0)}
                                    </div>
                                    <span className="text-[9px] font-bold truncate max-w-[60px]">
                                      {
                                        members
                                          .find(
                                            (m) => m.id === event.module_assignments?.[module.id]
                                          )
                                          ?.fullName.split(' ')[0]
                                      }
                                    </span>
                                  ...
                                  <Badge
                                    variant="outline"
                                    className="h-5 text-[8px] font-black tracking-widest bg-primary/5 text-primary border-none"
                                  >
                                    UNASSIGNED
                                  </Badge>
                                )}
                    ...
                    <motion.div
                      ...
                      onClick={() => setActiveTab('library')} // Assuming library is the marketplace or add tab? Actually the button "ACTIVATE MODULES" is the dialog. This card might be redundant if the button exists, but let's keep it as a shortcut.
                    >
                      <div className="text-center space-y-4">
                        ...
                        <div>
                          <h4 className="font-serif font-black text-lg text-primary">
                            Provision Module
                          </h4>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {activeModules.map((module) => (
                      <Card
                        key={module.id}
                        className="p-8 bg-white rounded-[32px] border-none shadow-2xl shadow-primary/5"
                      >
                              ...
                              <Dialog>
                                <DialogTrigger asChild>
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                    className="h-8 px-4 rounded-lg bg-primary/5 text-primary text-[10px] font-black uppercase tracking-widest"
                                  >
              ...
              {activeTab === 'library' && (
                ...
                >
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      <h2 className="text-3xl font-serif font-black">Audit Log</h2>
                      <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground opacity-60">
                        System-wide operational history
                      </p>
                    </div>
                  </div>
                  <Card className="p-8 bg-white rounded-[32px] border-none shadow-2xl shadow-primary/5 flex items-center justify-center min-h-[400px]">
                    <div className="text-center space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground/60 max-w-md mx-auto">
                        All actions are being recorded. Visual log viewer coming in future update.
                        Check console for raw event streams.
                      </p>
                    </div>
                  </Card>
                </motion.div>
