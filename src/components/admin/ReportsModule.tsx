    ...
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 sm:gap-4">
        <div className="space-y-1">
          ...
          <p className="text-gray-600 text-xs sm:text-sm md:text-base">Generate and download comprehensive church reports.</p>
        </div>
        <Button 
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
        <Card className="h-full">
          <CardHeader className="p-3 sm:p-4 space-y-0">
            <div className="flex items-center justify-between">
              <CardTitle className="text-[10px] xs:text-xs sm:text-sm font-medium leading-tight">Reports Generated</CardTitle>
        ...
        <Card className="h-full">
          <CardHeader className="p-3 sm:p-4 space-y-0">
            <div className="flex items-center justify-between">
              <CardTitle className="text-[10px] xs:text-xs sm:text-sm font-medium leading-tight">Avg. Response Time</CardTitle>
        ...
        <Card className="h-full">
          <CardHeader className="p-3 sm:p-4 space-y-0">
            <div className="flex items-center justify-between">
              <CardTitle className="text-[10px] xs:text-xs sm:text-sm font-medium leading-tight">Most Requested</CardTitle>
              <Calendar className="h-3 w-3 sm:h-4 sm:w-4 text-muted-foreground flex-shrink-0" />
            </div>
          </CardHeader>
          <CardContent className="p-3 sm:p-4 pt-0">
            <div className="text-lg sm:text-xl md:text-2xl font-bold truncate">Attendance</div>
            <p className="text-[10px] xs:text-xs text-muted-foreground mt-0.5">42% of all reports</p>
          </CardContent>
        </Card>
        ...
        <Card className="h-full">
          <CardHeader className="p-3 sm:p-4 space-y-0">
            <div className="flex items-center justify-between">
              <CardTitle className="text-[10px] xs:text-xs sm:text-sm font-medium leading-tight">Total Downloads</CardTitle>
      ...
      <Card className="overflow-hidden">
        <CardHeader className="pb-2 sm:pb-4">
          ...
          <CardDescription className="text-xs sm:text-sm">Generate standardized reports for your church operations</CardDescription>
        </CardHeader>
                  ...
                  <div className="flex justify-between items-start gap-2">
                    <div className="flex items-start space-x-2 sm:space-x-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <CardTitle className="text-sm sm:text-base font-semibold truncate">{report.title}</CardTitle>
      ...
      <Card className="overflow-hidden">
        <CardHeader className="pb-2 sm:pb-4">
          ...
          <CardDescription className="text-xs sm:text-sm">Recently generated reports available for download</CardDescription>
        </CardHeader>
        <CardContent className="p-2 sm:p-4 pt-0">
          <div className="space-y-2 sm:space-y-3">
              ...
              >
                <div className="flex items-start space-x-3 min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    <h4 className="font-medium text-sm sm:text-base leading-tight truncate">{report.name}</h4>
                    <div className="mt-1 flex flex-col xs:flex-row xs:items-center xs:flex-wrap gap-x-3 gap-y-1 text-[10px] xs:text-xs text-gray-500">
                      ...
                      <Badge 
                        variant="outline" 
                        className="ml-0 xs:ml-1.5 text-[10px] h-5 mt-0.5"
                      >
                        {report.type}
                      </Badge>
                    </div>
