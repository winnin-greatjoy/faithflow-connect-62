    ...
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
        <div>
          ...
          <p className="text-sm sm:text-base text-gray-600 mt-1 sm:mt-2">
            Coordinate volunteers and their service schedules.
          </p>
        </div>
            ...
            <Table>
              <TableHeader className="hidden sm:table-header-group">
                <TableRow>
                  ...
                  <TableHead className="min-w-[120px] text-xs sm:text-sm hidden md:table-cell">
                    Next Shift
                  </TableHead>
                  <TableHead className="min-w-[100px] text-xs sm:text-sm">Status</TableHead>
                  <TableHead className="min-w-[100px] text-xs sm:text-sm text-right pr-6">
                    Actions
                  </TableHead>
                </TableRow>
              </TableHeader>
                  ...
                  <TableRow key={role.id} className="block sm:table-row border-b last:border-0">
                    ...
                    <TableCell className="block sm:table-cell px-4 py-3 sm:px-6 sm:py-4">
                      <div className="flex justify-between sm:block">
                        ...
                        <span className="text-sm sm:text-base">
                          {role.members} {role.members === 1 ? 'volunteer' : 'volunteers'}
                        </span>
                      </div>
                    </TableCell>
                    <TableCell className="block sm:table-cell px-4 py-3 sm:px-6 sm:py-4">
                    ...
                    <TableCell className="block sm:table-cell px-4 py-3 sm:px-6 sm:py-4">
                      <div className="flex justify-between items-center sm:block">
                        ...
                        <Badge
                          className={`${getStatusColor(role.status)} text-xs sm:text-sm h-5 sm:h-6`}
                        >
                          {role.status}
                        </Badge>
                      </div>
      ...
      <Card>
        <CardHeader className="p-4 sm:p-6 pb-0 sm:pb-0">
          ...
          <CardDescription className="text-xs sm:text-sm">
            Next week's volunteer schedule
          </CardDescription>
        </CardHeader>
        <CardContent className="p-4 sm:p-6 pt-4">
          <div className="space-y-3 sm:space-y-4">
            {upcomingShifts.map((shift) => (
              <div
                key={shift.id}
                className="flex flex-col sm:flex-row justify-between p-4 border rounded-lg gap-4 bg-white shadow-sm hover:shadow transition-shadow"
              >
