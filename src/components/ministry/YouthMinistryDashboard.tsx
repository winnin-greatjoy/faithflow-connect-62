...
const YouthMinistryDashboard: React.FC<YouthMinistryDashboardProps> = ({ userRole }) => {
        ...
        <div className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">Youth Ministry</h1>
                <p className="text-muted-foreground">Engaging young people aged 13-25</p>
              </div>
            </div>
            {userRole === 'admin' && (
      ...
      <div className="p-4 sm:p-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Regular programs</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Average weekly</p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <p className="font-medium">Game Club</p>
          ...
          <TabsContent value="members">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage youth ministry membership</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="activities">
            <Card>
              <CardHeader>
                <CardTitle>Activities & Programs</CardTitle>
                <CardDescription>Schedule and manage youth activities</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8">
                  <Calendar className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
                  <p className="text-muted-foreground">Activities management coming soon</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="resources">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Study materials and youth resources</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8">
