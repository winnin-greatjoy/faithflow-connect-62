...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      asset_checkouts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'asset_checkouts_checked_out_to_fkey';
      ...
      child_checkins: {
        ...
        Relationships: [
          {
            foreignKeyName: 'child_checkins_checked_in_by_fkey';
          ...
          {
            foreignKeyName: 'child_checkins_checked_out_by_fkey';
            columns: ['checked_out_by'];
            isOneToOne: false;
            referencedRelation: 'profiles';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'child_checkins_event_id_fkey';
            columns: ['event_id'];
            isOneToOne: false;
            referencedRelation: 'events';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'child_checkins_guardian_id_fkey';
            columns: ['guardian_id'];
            isOneToOne: false;
            referencedRelation: 'members';
            referencedColumns: ['id'];
      ...
      event_attendance: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'event_attendance_zone_id_fkey';
            columns: ['zone_id'];
            isOneToOne: false;
      ...
      event_shift_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: 'event_shift_assignments_member_id_fkey';
            columns: ['member_id'];
            isOneToOne: false;
            referencedRelation: 'members';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'event_shift_assignments_shift_id_fkey';
            columns: ['shift_id'];
            isOneToOne: false;
      ...
      first_aid_posts: {
        ...
        Relationships: [
          {
            foreignKeyName: 'first_aid_posts_event_id_fkey';
            columns: ['event_id'];
            isOneToOne: false;
            referencedRelation: 'events';
            referencedColumns: ['id'];
      ...
      first_timers: {
        Row: {
          ...
          follow_up_status: Database['public']['Enums']['follow_up_status'] | null;
          full_name: string;
          id: string;
      ...
      healthcare_incidents: {
        ...
        Relationships: [
          {
            foreignKeyName: 'healthcare_incidents_affected_person_id_fkey';
            columns: ['affected_person_id'];
            isOneToOne: false;
            referencedRelation: 'members';
            referencedColumns: ['id'];
          },
          {
            foreignKeyName: 'healthcare_incidents_event_id_fkey';
            columns: ['event_id'];
            isOneToOne: false;
            referencedRelation: 'events';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'healthcare_incidents_reported_by_fkey';
            columns: ['reported_by'];
            isOneToOne: false;
            referencedRelation: 'profiles';
            referencedColumns: ['id'];
      ...
      members: {
        Row: {
          ...
          baptized_sub_level: Database['public']['Enums']['baptized_sub_level'] | null;
          branch_id: string;
          community: string;
          created_at: string | null;
          created_by: string | null;
      ...
      queue_tickets: {
        ...
        Relationships: [
          {
            foreignKeyName: 'queue_tickets_member_id_fkey';
            columns: ['member_id'];
            isOneToOne: false;
            referencedRelation: 'members';
            referencedColumns: ['id'];
      ...
      queues: {
        ...
        Relationships: [
          {
            foreignKeyName: 'queues_event_id_fkey';
            columns: ['event_id'];
            isOneToOne: false;
            referencedRelation: 'events';
            referencedColumns: ['id'];
      ...
      safeguarding_clearances: {
        ...
        Relationships: [
          {
            foreignKeyName: 'safeguarding_clearances_member_id_fkey';
            columns: ['member_id'];
            isOneToOne: false;
            referencedRelation: 'members';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'safeguarding_clearances_verified_by_fkey';
            columns: ['verified_by'];
            isOneToOne: false;
            referencedRelation: 'profiles';
            referencedColumns: ['id'];
      ...
      service_items: {
        ...
        Relationships: [
          {
            foreignKeyName: 'service_items_event_id_fkey';
            columns: ['event_id'];
            isOneToOne: false;
            referencedRelation: 'events';
            referencedColumns: ['id'];
      ...
      songs: {
        ...
        Relationships: [
          {
            foreignKeyName: 'songs_branch_id_fkey';
            columns: ['branch_id'];
            isOneToOne: false;
            referencedRelation: 'church_branches';
            referencedColumns: ['id'];
      ...
      worship_team_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: 'worship_team_assignments_event_id_fkey';
            columns: ['event_id'];
            isOneToOne: false;
            referencedRelation: 'events';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'worship_team_assignments_member_id_fkey';
            columns: ['member_id'];
            isOneToOne: false;
            referencedRelation: 'members';
            referencedColumns: ['id'];
    ...
    Enums: {
      ...
      event_status: 'draft' | 'published' | 'cancelled' | 'upcoming' | 'active' | 'ended';
      ...
      leader_role: 'pastor' | 'assistant_pastor' | 'department_head' | 'ministry_head';
